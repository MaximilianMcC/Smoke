...
public class Graphics
{
	...
	// Outlines of squares
	public static void DrawSquareOutline(Transform2D transform, float thickness, Color color) => DrawSquareOutline(transform.FullPosition, transform.Size, thickness, color);
